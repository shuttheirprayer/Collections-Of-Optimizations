...
@Mixin(targets = "mob_grinding_utils.events.ChickenFuseEvent", remap = false)
public abstract class MixinMguChickenFuseTag {

    @WrapOperation(
            method = "startChickenFuse",
            at = @At(
                    value = "INVOKE",
    ...
    private CompoundTag coo$readExistingFuseTag(LivingEntity entity, Operation<CompoundTag> original) {
